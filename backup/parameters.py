...
class Parameters:
    def __init__(self):
        ...
        # pixelsnail args
        self.n_channels=64     # 256 #'Number of channels for residual blocks.')
        self.n_res_layers=2     # 5 #'Number of residual blocks in each attention layer.')
        self.attn_n_layers=2   # 12 #'Number of attention layers.')
        self.attn_nh=1          # 1'Number of attention heads.')
        self.attn_dq=16         # 16 #'Size of attention queries and keys.')
        self.attn_dv=64       # 128 #'Size of attention values.')
        ...
        self.cuda='0,1,2,3'           #'Which cuda device to use.')
        
        # data params
        self.dataset='lung'
        self.n_cond_classes=None    #'Number of classes for class conditional model.')
        self.n_bits=4               #'Number of bits of input data.')
        self.image_dims=(3,128,128) #'Dimensions of the input data.')
        self.output_dims=(3,128,128) #'Dimensions of the output data')
        self.data_path=r''       #help='Location of datasets.')
        self.mini_data=False
        
        # training param
        self.lr=8e-4            #'Learning rate.')
        ...
        self.batch_size=30      #'Training batch size.')
        self.n_epochs=1024        #'Number of epochs to train.')
        ...
        self.eval_interval=256   #'How often to evaluate and save samples.')
